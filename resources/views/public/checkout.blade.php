                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="p-4">
                            ...
                            <ul class="list-unstyled mb-4">
                                ...
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                            class="text-muted">Shipping Cost</strong><strong></strong></li>
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                            class="text-muted">Total</strong>
                                    <h5 class="font-weight-bold">{{ __('currency.code') }} {{ session('cart.total_price') }}</h5>
                                </li>
                            </ul>
                            <a href="#" class="btn btn-primary rounded-pill py-2 btn-block">Proceed to checkout</a>
                        </div>
                    </div>
                </div>
